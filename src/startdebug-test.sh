...
/usr/X11R6.3/bin/xhost + mpc3-lip6
...
/usr/bin/rsh  -n mpc3-lip6 '/usr/X11R6.3/bin/xterm -display pmpc6:0 -T mpc3-lip6 -geometry 80x11+3+358 -e /bin/csh -c "cd /eowynhome/alex/cvs/alex/MPC-OS-5/modules; /usr/local/bin/zsh"' &
/usr/bin/rsh  -n mpc3-lip6 '/usr/X11R6.3/bin/xterm -display pmpc6:0 -T mpc3-lip6 -geometry 80x11+513+358 -e /bin/csh -c "cd /eowynhome/alex/cvs/alex/MPC-OS-5/modules; /usr/local/bin/zsh"' &
/usr/bin/rsh  -n mpc3-lip6 '/usr/X11R6.3/bin/xterm -display pmpc6:0 -T mpc3-lip6 -geometry 80x11+3+536 -e /bin/csh -c "cd /eowynhome/alex/cvs/alex/MPC-OS-5/modules; /usr/local/bin/zsh"' &
/usr/bin/rsh  -n mpc3-lip6 '/usr/X11R6.3/bin/xterm -display pmpc6:0 -T mpc3-lip6 -geometry 80x11+513+536 -e /bin/csh -c "cd /eowynhome/alex/cvs/alex/MPC-OS-5/modules; /usr/local/bin/zsh"' &
